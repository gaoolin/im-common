package org.im.semiconductor.equipment.parameter;

import org.im.common.security.AccessLevel;
import org.im.semiconductor.equipment.parameter.mgr.ParameterRange;
import org.im.semiconductor.equipment.parameter.mgr.ParameterStatus;
import org.im.semiconductor.equipment.parameter.mgr.ParameterType;
...
public abstract class AbstractParameter implements ParameterInterface {
    ...
    public String toString() {
        return "AbstractParameter{" + "deviceId='" + deviceId + '\'' + ", parameterName='" + parameterName + '\'' + ", parameterValue=" + parameterValue + ", parameterType=" + parameterType + ", parameterDescription='" + parameterDescription + '\'' + ", parameterUnit='" + parameterUnit + '\'' + ", parameterStatus=" + parameterStatus + ", version='" + version + '\'' + ", createTime=" + createTime + ", updateTime=" + updateTime + ", readOnly=" + readOnly + ", accessLevel=" + accessLevel + ", tags=" + tags + ", metadata=" + metadata + ", parentParameter=" + parentParameter + ", childParameters=" + childParameters + '}';
    }
}

...
public class BatchProcessorKit {
    ...
    public static class BatchConfig {
        ...
        public BatchConfig setBatchSize(int batchSize) { this.batchSize = batchSize; return this; }

        public int getRetryCount() { return retryCount; }
        public BatchConfig setRetryCount(int retryCount) { this.retryCount = retryCount; return this; }

        public long getRetryDelay() { return retryDelay; }
        public BatchConfig setRetryDelay(long retryDelay) { this.retryDelay = retryDelay; return this; }

        public boolean isContinueOnError() { return continueOnError; }
        public BatchConfig setContinueOnError(boolean continueOnError) { this.continueOnError = continueOnError; return this; }
    }

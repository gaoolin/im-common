...
public class CacheFactory {
    ...
    public <K, V> Cache<K, V> create(CacheConfig config) {
        if (config == null) {
            ...
            config = CacheConfigBuilder.create().withBackendType(BackendType.MEMORY).build();
        }
    ...
    public <K, V> Cache<K, V> createDefault() {
        CacheConfig config = CacheConfigBuilder.create().withBackendType(BackendType.MEMORY).build();

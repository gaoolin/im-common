...
public class WbOlpRawDataCompositeKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1997607006957163822L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"policy\":\"record\",\"name\":\"WbOlpRawDataCompositeKey\",\"namespace\":\"com.im.qtech.data.avro.serializer\",\"fields\":[{\"name\":\"dt\",\"policy\":{\"policy\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"simId\",\"policy\":\"string\"},{\"name\":\"module\",\"policy\":\"string\"},{\"name\":\"wireId\",\"policy\":\"int\"},{\"name\":\"checkPort\",\"policy\":\"int\"},{\"name\":\"piecesIndex\",\"policy\":\"int\"}]}");
   ...
   */
  public static com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder newBuilder() {
    return new com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder();
  }
   ...
   * @return A new WbOlpRawDataCompositeKey RecordBuilder
   */
  public static com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder newBuilder(com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder other) {
    if (other == null) {
      return new com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder();
    } else {
      return new com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder(other);
    }
  }
   ...
   * @return A new WbOlpRawDataCompositeKey RecordBuilder
   */
  public static com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder newBuilder(com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey other) {
    if (other == null) {
      return new com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder();
    } else {
      return new com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WbOlpRawDataCompositeKey>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.dt)) {
        this.dt = data().deepCopy(fields()[0].schema(), other.dt);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder setDt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder clearDt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder setSimId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder clearSimId() {
      simId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder setModule(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder clearModule() {
      module = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder setWireId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder clearWireId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder setCheckPort(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder clearCheckPort() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder setPiecesIndex(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.im.qtech.data.avro.serializer.WbOlpRawDataCompositeKey.Builder clearPiecesIndex() {

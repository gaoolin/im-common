 ...
 */
public final class LpOcHandler extends CommandHandler<EqLstCommand> implements AutoRegisteredHandler<EqLstCommand> {
    // 饿汉式单例
    public static final LpOcHandler INSTANCE = new LpOcHandler();

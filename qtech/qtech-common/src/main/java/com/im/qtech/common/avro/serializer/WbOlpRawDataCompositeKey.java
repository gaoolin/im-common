...
public class WbOlpRawDataCompositeKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = -8009254394656479755L;


    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"WbOlpRawDataCompositeKey\",\"namespace\":\"com.im.qtech.common.avro.serializer\",\"fields\":[{\"name\":\"dt\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"simId\",\"type\":\"string\"},{\"name\":\"module\",\"type\":\"string\"},{\"name\":\"wireId\",\"type\":\"int\"},{\"name\":\"checkPort\",\"type\":\"int\"},{\"name\":\"piecesIndex\",\"type\":\"int\"}]}");
     ...
     */
    public WbOlpRawDataCompositeKey(java.time.Instant dt, java.lang.CharSequence simId, java.lang.CharSequence module, java.lang.Integer wireId, java.lang.Integer checkPort, java.lang.Integer piecesIndex) {
     ...
     */
    public static com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder newBuilder() {
        return new com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder();
    }
     ...
     * @return A new WbOlpRawDataCompositeKey RecordBuilder
     */
    public static com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder newBuilder(com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder other) {
        if (other == null) {
            return new com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder();
        } else {
            return new com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder(other);
        }
    }
     ...
     * @return A new WbOlpRawDataCompositeKey RecordBuilder
     */
    public static com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder newBuilder(com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey other) {
        if (other == null) {
            return new com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder();
        } else {
            return new com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WbOlpRawDataCompositeKey>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.dt)) {
                this.dt = data().deepCopy(fields()[0].schema(), other.dt);
         ...
         * @return This builder.
         */
        public com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder setDt(java.time.Instant value) {
         ...
         * @return This builder.
         */
        public com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder clearDt() {
         ...
         * @return This builder.
         */
        public com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder setSimId(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder clearSimId() {
            simId = null;
         ...
         * @return This builder.
         */
        public com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder setModule(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder clearModule() {
            module = null;
         ...
         * @return This builder.
         */
        public com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder setWireId(int value) {
         ...
         * @return This builder.
         */
        public com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder clearWireId() {
         ...
         * @return This builder.
         */
        public com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder setCheckPort(int value) {
         ...
         * @return This builder.
         */
        public com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder clearCheckPort() {
         ...
         * @return This builder.
         */
        public com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder setPiecesIndex(int value) {
         ...
         * @return This builder.
         */
        public com.im.qtech.common.avro.serializer.WbOlpRawDataCompositeKey.Builder clearPiecesIndex() {

...
public class EqpReverseInfoRecordValueSerializer implements Serializer<EqpReverseInfoRecord> {
    ...
    private final DatumWriter<EqpReverseInfoRecord> datumWriter = new SpecificDatumWriter<>(SCHEMA);
    ...
    @Override
    public byte[] serialize(String topic, EqpReverseInfoRecord data) {
        if (data == null) {
            return null;
        }

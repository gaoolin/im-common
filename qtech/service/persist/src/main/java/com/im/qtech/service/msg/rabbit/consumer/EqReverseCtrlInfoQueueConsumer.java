 ...
 */
@Component
public class EqReverseCtrlInfoQueueConsumer implements DisposableBean {
    ...
    public EqReverseCtrlInfoQueueConsumer(IEqpReverseInfoService service, RedisTemplate<String, EqpReverseInfo> template) {

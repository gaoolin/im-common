...
public class CacheService {
     ...
     */
    public CheckResult getCheckResult(EqpContextInfoImpl param) {
     ...
     * @return 缓存键
     */
    private String generateCacheKey(EqpContextInfoImpl param) {
        return param.getDeviceId() + ":" + param.getDeviceName();
    }

 ...
 * 用于验证ORM框架的关联字段加载功能
 */
public class FinalAssociationLoadingTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            // 测试关联加载功能
            testFinalAssociationLoading();

            // 清理资源
            cleanup();

            System.out.println("关联加载完整功能测试完成");
        } catch (Exception e) {
            System.err.println("关联加载完整功能测试失败: " + e.getMessage());
            e.printStackTrace();
        }
    }
     ...
     * 测试关联加载功能
     */
    private static void testFinalAssociationLoading() {
        System.out.println("开始测试关联加载功能...");
        ...
        try {
            ...
            // 测试根据ID查询实体
            testFindByIdWithAssociation(session);
    ...
    private static void testQueryWithAssociation(MultiDataSourceSession session) {
        ...
        for (User user : users) {
            ...
            if (user.getDepartment() != null) {
                System.out.println("    关联部门: " + user.getDepartment().getName());
            } else {
                System.out.println("    关联部门: null");
            }
        }
     ...
     * @param session 会话
     */
    private static void testFindByIdWithAssociation(MultiDataSourceSession session) {
        System.out.println("测试根据ID查询实体...");
